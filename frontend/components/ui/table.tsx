  ...
  return (
    <tr className={cn('border-b', className)} {...props}>
      <td colSpan={colSpan} className='h-24 text-center'>
        <div className='text-muted-foreground flex flex-col items-center justify-center py-8 md:flex-row md:gap-2'>
          <FileX2 />
          <p className='text-sm font-light italic'>Không có dữ liệu</p>
        </div>
      </td>
    </tr>
  )
